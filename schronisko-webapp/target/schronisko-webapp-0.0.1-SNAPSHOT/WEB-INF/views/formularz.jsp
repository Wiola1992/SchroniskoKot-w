...
<body>
	...
	<br />
		...
		<form:form method="POST" modelAttribute="form"  accept-charset="UTF-8"> 
			<table border="1">
				<tr><td>Imię</td><td><form:input path="name"  /></td></tr>
				<tr><td>Waga</td><td><form:input path="weight" /></td></tr>
				<tr><td>Imię opiekuna</td><td><form:input path="nameOfGuardian" /></td></tr>
